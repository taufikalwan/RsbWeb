...
<section class="content pt-4">
      ...
      <div class="col-6">
            <div class="card p-2">
                ...
                <hr class="text-dark" style="color:#000;border-color:#222;">
                <img src="{{ Storage::url($order->payment_file) }}" alt="">
            </div>
          </div>
          <div class="col-6">
            <div class="card p-2">
                ...
                @if (!$order->trashed())
                        @if ($order->isUnPaid() && $order->isConfirmed())
                        ...
                        @if ($order->isDelivered())
                            ...
                            document.getElementById('complete-form-{{ $order->id }}').submit();"> Tandai Transaksi Selesai</a>		
